  ...
  <NavLink
    ...
    className={({ isActive }) =>
      `group flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-sm font-medium transition-all duration-200 ${
        isActive
          ? "bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-600 dark:to-indigo-600 text-white font-bold shadow-md shadow-blue-500/25"
...
export default function DashboardLayout({ links = [], title = "Dashboard" }) {
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950 flex flex-col antialiased text-slate-800 dark:text-slate-100 transition-colors duration-300 relative overflow-x-hidden">
      ...
      <div className="fixed top-1/3 -right-40 h-[450px] w-[450px] rounded-full bg-indigo-400/10 dark:bg-yellow-500/10 blur-3xl pointer-events-none" />
      ...
      <header className="sticky top-0 z-30 bg-white/90 dark:bg-slate-900/85 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800/80 shadow-sm transition-colors duration-300">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-xl bg-gradient-to-tr from-blue-600 via-indigo-600 to-blue-400 flex items-center justify-center text-white font-black text-sm shadow-md shadow-blue-500/25">
              WR
            </div>
            <div>
              ...
              <span className="text-[10px] font-bold text-blue-600 dark:text-yellow-400 uppercase tracking-widest">
                Enterprise Studio
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2.5 pl-3 border-l border-slate-200 dark:border-slate-800">
              <div className="h-9 w-9 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 dark:from-yellow-400 dark:to-amber-500 text-white dark:text-slate-950 font-black text-sm flex items-center justify-center shadow-md shadow-blue-500/20 dark:shadow-yellow-500/20">
                {initials}
              </div>
              <div className="hidden md:block text-left">
                <p className="text-xs font-bold text-slate-900 dark:text-slate-100 leading-tight">{user?.name || "User"}</p>
                <p className="text-[11px] text-blue-600 dark:text-yellow-400 font-semibold capitalize">{user?.role || "Member"}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8 py-6 flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 relative z-10">
        ...
        <aside className="lg:col-span-3 space-y-4">
          <div className="rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-900/90 backdrop-blur-xl shadow-md dark:shadow-slate-950/50 overflow-hidden sticky top-22 transition-colors duration-300">

            {/* User Profile Section */}
            <div className="p-4 border-b border-slate-100 dark:border-slate-800/80
              bg-gradient-to-br from-blue-600 to-indigo-700 dark:from-slate-900 dark:to-blue-950/60">
              <div className="flex items-center gap-3">
                <div className="h-12 w-12 rounded-xl bg-white/20 dark:bg-yellow-500/20 border-2 border-white/30 dark:border-yellow-500/30 text-white dark:text-yellow-300 font-black text-lg flex items-center justify-center shrink-0 shadow-md">
                  {initials}
                </div>
